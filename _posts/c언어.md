...
| --- | --- | --- | --- |  
| 정수형 | short int | 2 바이트 | 영문숫자 1문자 - -128 ~ 127 |
|  | unsigned short int | 2 바이트 | 영문숫자 1문자 - -128 ~ 127 |
|  | int | 4 바이트 | 영문숫자 3문자 - -128 ~ 127 |
|  | unsigned int | 4 바이트 | 영문숫자 1문자 - -128 ~ 127 | 1 바이트 | 영문숫자 1문자 - -128 ~ 127 |
|  | long int | 4 바이트 | 영문숫자 1문자 - -128 ~ 127 |
|  | unsigned long int | 4 바이트 | 영문숫자 1문자 - -128 ~ 127 |
| --- | --- | --- | --- |  
| 부동소수점형 | float | 4 바이트 | 영문숫자 1문자 - -128 ~ 127 |
|  | double | 8 바이트 | 영문숫자 1문자 - -128 ~ 127 |
|  | long double | 8 바이트 | 영문숫자 1문자 - -128 ~ 127 |
